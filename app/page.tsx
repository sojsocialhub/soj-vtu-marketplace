        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/dashboard"
                className="inline-flex items-center justify-center bg-white hover:bg-white/90 text-primary font-bold px-8 py-3 rounded-lg"
              >
                Get Started
              ...
              <Link
                href="/faq"
                className="inline-flex items-center justify-center border border-white/20 hover:bg-white/10 text-white px-8 py-3 rounded-lg"
              >
                Learn More
              </Link>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-border transition-all hover:shadow-md">
              ...
              <p className="text-muted-foreground">
                Transactions are processed instantly. No waiting around for your data or airtime.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-border transition-all hover:shadow-md">
              ...
              <p className="text-muted-foreground">
                Your funds are safe with us. We use advanced encryption for every transaction.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-border transition-all hover:shadow-md">
              ...
              <p className="text-muted-foreground">
                Fund your wallet via bank transfer and get credited quickly.
              </p>
            </div>
          </div>
        </div>
